...
# def same_color_row(row_i, column_i, min_column_i, pixel_data):
#   color = pixel_data[row_i][column_i]
...
class SameColorCornerPixel(unittest.TestCase):
  ...
  #   result = same_color_row(0,2,0,pixel_data)
  ...
  # def test_row_is_not_same_color1(self):
  #   pixel_data = {
  ...
  # def test_row_is_not_same_color2(self):
  #   pixel_data = {
